...
../target/release/plexpass -j true --master-username eddie --master-password Cru5h_rfIt:v_Bk asymmetric-decrypt --secret-key $prv --in-path enc_accounts.csv --out-path enc_accounts.csv
