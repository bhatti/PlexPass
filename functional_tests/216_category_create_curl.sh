...
curl -v -k -X POST https://localhost:8443/api/v1/categories --header "Content-Type: application/json; charset=UTF-8" --header "Authorization: Bearer $AUTH_TOKEN"  -d '{"name": "Gumball"}'
